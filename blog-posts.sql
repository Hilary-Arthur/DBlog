...
'饶佳瑞', '2025-04-15 10:00:00');


-- 2. Python 学习笔记
INSERT INTO `post` (`title`, `content`, `author`, `created_at`) VALUES
('Python 从入门到进阶：系统性学习笔记',
'## 项目简介
...
'饶佳瑞', '2025-03-20 10:00:00');


-- 3. JavaWeb 课程实践
INSERT INTO `post` (`title`, `content`, `author`, `created_at`) VALUES
('JavaWeb 课程实践：从基础语法到完整 Web 应用',
'## 项目简介

这是西南大学 JavaWeb 课程的教学实践项目集合，通过 **5 个递进式子模块**，带领学习者从 Java 基础语法一路走到完整的 Web 应用开发。
...
'饶佳瑞', '2025-05-01 10:00:00');


-- 4. IndexAge 浏览器起始页
INSERT INTO `post` (`title`, `content`, `author`, `created_at`) VALUES
('IndexAge：一个零依赖的浏览器新标签页扩展',
'## 项目简介
...
'饶佳瑞', '2025-04-28 10:00:00');


-- 5. 待办清单桌面工具
INSERT INTO `post` (`title`, `content`, `author`, `created_at`) VALUES
('待办清单：一个轻量级 Python 桌面 Todo 工具',
'## 项目简介
...
'饶佳瑞', '2025-03-10 10:00:00');


-- 6. Claude Code 模型切换器
INSERT INTO `post` (`title`, `content`, `author`, `created_at`) VALUES
('Model Switcher：Claude Code 多模型一键切换工具',
'## 项目简介
